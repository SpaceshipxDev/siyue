...
$config = [ordered]@{
  ...
  machines = @(
    [ordered]@{ id = 'lynuc-01'; name = 'LYNUC 01'; ip = '192.168.10.140' },
    [ordered]@{ id = 'lynuc-02'; name = 'LYNUC 02'; ip = '192.168.10.141' },
    [ordered]@{ id = 'lynuc-03'; name = 'LYNUC 03'; ip = '192.168.10.142' }
  )
}
...
Write-Host 'Testing all three CNC connections and the production endpoint...'
